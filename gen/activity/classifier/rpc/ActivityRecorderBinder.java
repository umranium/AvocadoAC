...
this.submitClassification(_arg0, _arg1, _arg2, _arg3);
reply.writeNoException();
return true;
}
...
case TRANSACTION_handleHardwareFaultException:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _arg0;
_arg0 = data.readString();
java.lang.String _arg1;
_arg1 = data.readString();
this.handleHardwareFaultException(_arg0, _arg1);
reply.writeNoException();
return true;
}
}
...
public void submitClassification(long sampleTime, java.lang.String classification, double eeAct, double met) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
_data.writeDouble(eeAct);
_data.writeDouble(met);
...
public void handleHardwareFaultException(java.lang.String title, java.lang.String msg) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_handleHardwareFaultException, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_handleHardwareFaultException = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
}
public boolean isRunning() throws android.os.RemoteException;
public void submitClassification(long sampleTime, java.lang.String classification, double eeAct, double met) throws android.os.RemoteException;
public java.util.List<activity.classifier.rpc.Classification> getClassifications() throws android.os.RemoteException;
